...
{{--                <div class="inner">--}}
{{--                    <h3>{{number_format($order_sum_grand_total_today)   }}<sup style="font-size: 20px"> </sup></h3>--}}

{{--                    <p>Sum grand total today</p>--}}
{{--                </div>--}}
{{--                <div class="icon">--}}
...
{{--                <div class="inner">--}}
{{--                    <h3>{{$order_status_today}}</h3>--}}
{{--                    <h3>{{$order_status_today_1}}</h3>--}}

{{--                    <p>So don hoan thanh</p>--}}
{{--                </div>--}}
{{--                <div class="icon">--}}
...
{{--                <div class="inner">--}}
{{--                    <h3>{{$order_status_today_0}}</h3>--}}
{{--                    <h3>{{$order_status_today_grand}}</h3>--}}
